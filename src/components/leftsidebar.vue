<template>
	<ul id="myTab" class="nav nav-tabs nav-stacked class-hd">
		<!-- <router-link tag="li" active-class="active" to=""><a href="#nznz" data-toggle="tab" >男装女装</a></router-link>
		<router-link tag="li" active-class="active" to=""><a href="#nxnx" data-toggle="tab">男鞋女鞋</a></router-link> -->
